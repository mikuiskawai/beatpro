...
function endGame() {
    ...
    }else if (finalScore >= 100000) {//761
        message = 'GODLY!';
    }else if (finalScore >= 80000 && finalScore < 100000) {//761
        message = 'LEDGENDARY!';
    }else if (finalScore >= 50000 && finalScore < 80000) {//761
        message = 'EXCELENT!';
    } else if (finalScore >= 35000 && finalScore < 50000) {//761
        message = 'WELL DONE!';
    }else if (finalScore >= 25000 && finalScore < 35000) {//761
        message = 'GREAT!';
    }else if (finalScore >= 20000 && finalScore < 25000) {//761
        message = 'GOOD!';
