...
function endGame() {
    ...
    }else if (finalScore >= 1100000) {//761
        message = 'GODLY!';
    }else if (finalScore >= 750000 && finalScore < 1100000) {//761
        message = 'LEDGENDARY!';
    }else if (finalScore >= 500000 && finalScore < 750000) {//761
        message = 'EXCELENT!';
    } else if (finalScore >= 400000 && finalScore < 500000) {//761
        message = 'WELL DONE!';
    }else if (finalScore >= 300000 && finalScore < 400000) {//761
        message = 'GREAT!';
    }else if (finalScore >= 200000 && finalScore < 300000) {//761
        message = 'GOOD!';
