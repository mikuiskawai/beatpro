...
function endGame() {
    ...
    }else if (finalScore >= 200000 ) {//761
        message = 'GODLY!';
    }else if (finalScore >= 180000 && finalScore < 200000) {//761
        message = 'LEDGENDARY!';
    }else if (finalScore >= 150000 && finalScore < 180000) {//761
        message = 'EXCELENT!';
    } else if (finalScore >= 120000 && finalScore < 150000) {//761
        message = 'WELL DONE!';
    }else if (finalScore >= 100000 && finalScore < 120000) {//761
        message = 'GREAT!';
    }else if (finalScore >= 60000 && finalScore < 100000) {//761
        message = 'GOOD!';
    } else if (finalScore >= 30000 && finalScore < 60000) {
        message = 'NOT BAD!';
