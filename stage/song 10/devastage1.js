...
function endGame() {
    ...
    }else if (finalScore >= 250000) {//761
        message = 'GODLY!';
    }else if (finalScore >= 230000 && finalScore < 250000) {//761
        message = 'LEDGENDARY!';
    }else if (finalScore >= 200000 && finalScore < 230000) {//761
        message = 'EXCELENT!';
    } else if (finalScore >= 160000 && finalScore < 200000) {//761
        message = 'WELL DONE!';
    }else if (finalScore >= 120000 && finalScore < 160000) {//761
        message = 'GREAT!';
    }else if (finalScore >= 80000 && finalScore < 120000) {//761
        message = 'GOOD!';
    } else if (finalScore >= 30000 && finalScore < 80000) {
        message = 'NOT BAD!';
    } else if (finalScore >= 10000 && finalScore < 30000) {
        message = 'Bad!';
    } else {
        message = 'Fail!';
    }
