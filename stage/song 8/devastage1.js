...
function endGame() {
    ...
    }else if (finalScore >= 150000) {//761
        message = 'GODLY!';
    }else if (finalScore >= 110000 && finalScore < 150000) {//761
        message = 'LEDGENDARY!';
    }else if (finalScore >= 80000 && finalScore < 110000) {//761
        message = 'EXCELENT!';
    } else if (finalScore >= 50000 && finalScore < 80000) {//761
        message = 'WELL DONE!';
    }else if (finalScore >= 30000 && finalScore < 50000) {//761
        message = 'GREAT!';
    }else if (finalScore >= 20000 && finalScore < 30000) {//761
        message = 'GOOD!';
